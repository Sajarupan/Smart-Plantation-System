...
#define RELAY_PIN 26 // Change this to the pin connected to your relay
...
const char* password = "7HMQNA3M8GQ";    // change password

unsigned long lastSend = 0; // Variable to store the last time data was sent
...
void loop() {
  ...
  if (sht.readSample()) {
    ...
    if (currentMillis - lastSend >= 10000) {
      ...
      lastSend = currentMillis; // Update the last send time
    }
